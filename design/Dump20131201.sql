...
INSERT INTO `r_category` VALUES (6,'单词听写',2,''),(7,'识别生字',3,'sdfsr'),(8,'朗读材料',4,''),(9,'图画演示',1,'');
...
INSERT INTO `s_function` VALUES (1,'add','新增'),(2,'delete','删除'),(3,'modify','修改'),(4,'query','查询'),(5,'refresh','刷新'),(6,'join','挂接'),(7,'modify_pwd','修改密码'),(8,'sort','排序'),(9,'modify_many','批量修改'),(10,'add_many','批量增加'),(11,'super_query','超级浏览权限');
...
INSERT INTO `s_menu` VALUES (40,-1,'用户管理','','',''),(41,-1,'资源库系统','','',''),(45,-1,'在线备课','','',''),(46,61,'菜单管理','App/System/Menu/MenuManage.html','1;2;3','./App/Lib/icons/32X32/product_169.gif'),(47,40,'角色管理','App/System/Role/RoleManage.html','1;2;3;6','./App/Lib/icons/32X32/product_169.gif'),(48,40,'用户管理','App/System/User/UserManage.html','1;2;3;6;7;9','./App/Lib/icons/32X32/product_169.gif'),(49,61,'功能管理','App/System/Function/FunctionManage.html','1;3','./App/Lib/icons/32X32/product_169.gif'),(51,41,'学科管理','App/Resources/Subject/SubjectManage.html','1;2;3','./App/Lib/icons/32X32/product_169.gif'),(52,41,'年级管理','App/Resources/Grade/GradeManage.html','1;2;3','./App/Lib/icons/32X32/product_169.gif'),(53,41,'类别管理','App/Resources/Category/CategoryManage.html','1;2;3;8','./App/Lib/icons/32X32/product_169.gif'),(54,41,'课程管理','App/Resources/Course/CourseManage.html','1;2;3;4;5','./App/Lib/icons/32X32/product_169.gif'),(55,41,'资源管理','App/Resources/Source/SourceManage.html','1;2;3;5;11','./App/Lib/icons/32X32/product_169.gif'),(56,-1,'专题系统','','',''),(57,41,'专题管理','App/Resources/Topic/TopicManage.html','1;2;3;6','./App/Lib/icons/32X32/product_169.gif'),(61,-1,'网站管理','','',''),(62,61,'页面生成','App/Website/Page/PageManage.html','5','./App/Lib/icons/32X32/product_169.gif'),(63,40,'学生管理','App/System/Student/StudentManage.html','1;2;3;9;10','./App/Lib/icons/32X32/product_169.gif'),(65,61,'新闻管理','App/Website/News/NewsManage.html','1;2;3;5','./App/Lib/icons/32X32/product_169.gif'),(66,61,'轮播图片管理','App/Website/Pictures/PicturesManage.html','1;2;3','./App/Lib/icons/32X32/product_169.gif');
...
INSERT INTO `s_role_menu_join` VALUES (222,5,51,'1;2;3'),(223,5,52,'1;2;3'),(224,5,53,'1;2;3;8'),(225,5,54,'1;2;3;4'),(226,5,55,'1;2;3'),(227,5,57,'1;2;3;6'),(228,6,62,'5'),(229,7,46,'1;3'),(230,7,47,'1;2;3;6'),(231,7,48,'1;2;3;6;7'),(421,18,46,'1;3'),(422,18,47,'1;2;3;6'),(423,18,48,'1;2;3;6;7;10'),(424,18,49,'1;3'),(425,18,51,'1;2;3'),(426,18,52,'1;2;3'),(427,18,53,'1;2;3;8'),(428,18,54,'1;2;3;4;5'),(429,18,55,'1;2;3;5'),(472,4,46,'1;2;3'),(473,4,47,'1;3;6'),(474,4,48,'1;2;3;6;7;9'),(475,4,49,'1;3'),(476,4,51,'1;2;3'),(477,4,52,'1;2;3'),(478,4,53,'1;2;3;8'),(479,4,54,'1;2;3;4;5'),(480,4,55,'1;2;3;5;11'),(481,4,57,'1;2;3;6'),(482,4,62,'5'),(483,4,63,'1;2;3;9;10'),(484,4,65,'1;2;3;5'),(485,4,66,'1;2;3');
...
INSERT INTO `s_user` VALUES (6,'admin','123456','管理员','1232324','0','678768','787',NULL,'2013-10-07','8678',0,'2013-11-30','2013-12-01',NULL,NULL),(8,'我叫测试','123456','sjakdjksa','430221199103102526','0','646208563','15575847475',NULL,'2013-08-07','sdhs',0,'2013-11-30',NULL,NULL,''),(9,'测试用户1号','123456','开发者','123456789123456789','0','646208563','11111111111',NULL,'2013-10-14','公管中心',0,'2013-05-30',NULL,NULL,''),(11,'我会告诉你所有的密码都是123456','123456','开发者','123456789987456123','1','23434','12343235',NULL,'2013-10-01','俺的沙发',0,'2013-06-30',NULL,NULL,'23423'),(12,'asdasdasdasdas','111111','awd','12322435','0','1231231','12312312312',NULL,'2013-10-07','12312321',0,'2013-07-30',NULL,NULL,''),(18,'asfg','123','tf','4324','0','23423','2342','23423','2013-11-18','342',0,'2013-08-30',NULL,NULL,'234234'),(19,'asasdasd','123','aesdf','sdfsadf','0','asdfsd','asdfsa','asdfsa','2013-11-05','asfsad',0,'2013-09-30',NULL,NULL,'asdfsd'),(20,'2131231231','123','123','rfe','0','234234','23423','23423','2013-11-04','12312',0,'2013-09-30',NULL,NULL,'23423'),(21,'2','2','2','2','1','2','2','2','2013-11-05','2',0,'2013-10-30',NULL,NULL,'2'),(22,'124324546567657','123','sdfs','sadfs','0','sdfsa','sadfs','sdfsd','2013-11-04','sadfs',0,'2013-10-30',NULL,NULL,'sdfsd'),(23,'admin2','123','dsgd','sdfsd','0','sdfsd','sdfsd','sdfs','2013-11-13','sdfsd',0,'2013-10-30',NULL,NULL,'sdfsd');
...
INSERT INTO `s_user_role_join` VALUES (69,8,4),(70,9,6),(72,9,8),(73,9,9),(82,11,6),(83,11,7),(84,11,8),(85,11,9),(86,6,4),(88,21,7),(89,21,5);
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `v_topic_source` AS select `t3`.`id` AS `id`,`t1`.`id` AS `sourceId`,`t1`.`name` AS `sourceName`,`t1`.`courseId` AS `courseId`,`t1`.`keyWords` AS `keyWords`,`t1`.`mediaType` AS `mediaType`,`t1`.`mediaFormat` AS `mediaFormat`,`t1`.`playTime` AS `playTime`,`t1`.`fileSize` AS `fileSize`,`t1`.`author` AS `sourceAuthor`,`t1`.`publisher` AS `publisher`,`t1`.`description` AS `sourceDescription`,`t1`.`createDate` AS `createDate`,`t1`.`approvalStatus` AS `approvalStatus`,`t1`.`price` AS `price`,`t1`.`viewTimes` AS `viewTimes`,`t1`.`useTimes` AS `useTimes`,`t1`.`url` AS `url`,`t1`.`createUserId` AS `createUserId`,`t2`.`id` AS `topicId`,`t2`.`name` AS `topicName`,`t2`.`description` AS `topicDescription`,`t2`.`author` AS `topicAuthor`,`t2`.`remark` AS `remark` from ((`r_topic_source_join` `t3` join `r_topic` `t2` on((`t3`.`topicId` = `t2`.`id`))) join `r_source` `t1` on((`t3`.`sourceId` = `t1`.`id`))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2013-12-01 16:17:39
