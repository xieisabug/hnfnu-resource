...
INSERT INTO `s_function` VALUES (1,'add','新增'),(2,'delete','删除'),(3,'modify','修改'),(4,'query','查询'),(5,'refresh','刷新'),(6,'join','挂接'),(7,'modify_pwd','修改密码'),(8,'sort','排序'),(9,'modify_many','批量修改'),(10,'add_many','批量增加'),(11,'super_query','超级浏览权限'),(12,'add_subtitle','增加二级标题'),(13,'upload','上传资源'),(14,'query_subtitle','查看二级标题');
...
INSERT INTO `s_role` VALUES (4,'管理员',NULL,'','超级管理员'),(5,'资源录入员',6,NULL,''),(6,'静态页面生成员',NULL,'匡静','asdas'),(7,'测试角色1号',6,'开发者',''),(8,'测试角色2号',NULL,NULL,''),(9,'测试角色3号',6,'开发者',''),(18,'管理员',6,'开发者',''),(19,'123',6,'管理员','123'),(20,'2',6,'管理员','2');
...
-- Dump completed on 2013-12-09 20:47:58
