...
CREATE TABLE `r_grade` (
  ...
  `remark` text,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=17 DEFAULT CHARSET=utf8 COMMENT='年级表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `r_grade` VALUES (1,'一年级','243234'),(8,'二年级',''),(9,'三年级','二手房是的'),(10,'四年级','所答非所问'),(11,'五年级','fdgd'),(12,'六年级','546456'),(13,'七年级','2433245'),(14,'八年级',''),(15,'九年级',''),(16,'高中','123412');
...
-- Dump completed on 2013-12-26 11:08:54
