...
CREATE TABLE `r_topic` (
  ...
  `remark` text COMMENT '备注',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='专题资源\n';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `s_user_habit` VALUES (12,5,2),(12,6,1),(6,7,1),(6,8,1),(6,9,1);
...
INSERT INTO `s_user_role_join` VALUES (69,8,4),(70,9,6),(72,9,8),(73,9,9),(82,11,6),(83,11,7),(84,11,8),(85,11,9),(86,6,4),(88,21,7),(89,21,5),(90,18,5);
...
-- Dump completed on 2013-12-02 13:56:24
