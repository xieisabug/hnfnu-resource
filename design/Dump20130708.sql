...
CREATE TABLE `r_source` (
  ...
  `categoryId` int(11) NOT NULL COMMENT '属于的类别的id',
  ...
  `approvalStatus` varchar(45) DEFAULT NULL COMMENT '审核状态',
...
INSERT INTO `s_role_menu_join` VALUES (17,2,46,'1;2;3'),(18,2,47,'1;2;3;6'),(24,1,46,'1;2'),(25,1,47,'1;2;3;6'),(26,1,48,'1;2;3;6'),(27,1,49,'1;2;3');
...
-- Dump completed on 2013-07-08 15:32:13
