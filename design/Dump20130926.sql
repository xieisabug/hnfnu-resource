...
CREATE TABLE `r_category` (
  ...
  `remark` text,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='类别表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `r_category` VALUES (2,'规范',1,'sdfsad'),(3,'风格和反对',3,'发v大发'),(4,'说东方闪电',2,'地方vgdf111'),(5,'随碟附送',4,'asd');
...
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `r_category_BDEL` BEFORE DELETE ON r_category FOR EACH ROW
-- Edit trigger body code below this line. Do not edit lines above this one
BEGIN
	DELETE FROM r_source WHERE r_source.id in (
		SELECT sourceId FROM r_source_category_join
			WHERE r_source_category_join.categoryId = old.id
	);
	DELETE FROM r_source_category_join 
		WHERE r_source_category_join.categoryId = old.id;
END */;;
DELIMITER ;
...
INSERT INTO `r_source` VALUES (3,'匡静个人简历',3,'匡静个人简历','','doc','','282112','','','','2013-09-21 16:50:33','0',NULL,0,0,0,'F:\\workspaces\\hnfnu-resource\\trunk\\hnfnuzyw\\WebRoot\\uploads\\201309211650035匡静个人简历.doc',6),(4,'给第三方',4,'dfgdfg;给第三方','','jpg','','119678','','','','2013-09-21 17:02:58','0',NULL,0,0,0,'F:\\workspaces\\hnfnu-resource\\trunk\\hnfnuzyw\\WebRoot\\uploads\\201309211702281QQ图片20130907100755.jpg',6);
...
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='资源和类别的挂接表，一个资源有多个类别。一个类别也可以属于多个资源';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `r_source_category_join` VALUES (3,3,2),(4,3,3),(5,3,4),(6,4,2),(7,4,3),(8,4,4);
...
INSERT INTO `s_menu` VALUES (40,-1,'管理系统','','',''),(41,-1,'资源库系统','','',''),(45,-1,'在线备课','','',''),(46,40,'菜单管理','App/System/Menu/MenuManage.html','1;2;3','./App/Lib/icons/32X32/product_169.gif'),(47,40,'角色管理','App/System/Role/RoleManage.html','1;2;3;6','./App/Lib/icons/32X32/product_169.gif'),(48,40,'用户管理','App/System/User/UserManage.html','1;2;3;6;7','./App/Lib/icons/32X32/product_169.gif'),(49,40,'功能管理','App/System/Function/FunctionManage.html','1;2;3','./App/Lib/icons/32X32/product_169.gif'),(50,40,'参数管理','App/System/Parameter/ParameterManage.html','1;2;3','./App/Lib/icons/32X32/product_169.gif'),(51,41,'学科管理','App/Resources/Subject/SubjectManage.html','1;2;3','./App/Lib/icons/32X32/product_169.gif'),(52,41,'年级管理','App/Resources/Grade/GradeManage.html','1;2;3','./App/Lib/icons/32X32/product_169.gif'),(53,41,'类别管理','App/Resources/Category/CategoryManage.html','1;2;3;8','./App/Lib/icons/32X32/product_169.gif'),(54,41,'课程管理','App/Resources/Course/CourseManage.html','1;2;3;4','./App/Lib/icons/32X32/product_169.gif'),(55,41,'资源管理','App/Resources/Source/SourceManage.html','1;2;3','./App/Lib/icons/32X32/product_169.gif'),(56,-1,'专题系统','','',''),(57,41,'专题管理','App/Resources/Topic/TopicManage.html','1;2;3;6','./App/Lib/icons/32X32/product_169.gif'),(58,41,'测试','','1;2;3;4',''),(61,-1,'网站系统','','',''),(62,61,'页面生成','App/Website/Page/PageManage.html','6','./App/Lib/icons/32X32/product_169.gif');
...
INSERT INTO `s_role_menu_join` VALUES (29,1,46,'1;2;3'),(30,1,47,'1;2;3;6'),(31,2,47,'1;2;3;6'),(117,6,48,'1;2;3;6'),(118,6,50,'1;2;3'),(119,6,51,'1;2;3'),(120,6,55,'1;2;3'),(134,3,53,'1;2;3'),(135,3,54,'1;2;3'),(136,3,55,'1;2;3'),(137,3,57,'1;2;3;6'),(162,4,46,'1;2;3'),(163,4,47,'1;2;3;6'),(164,4,48,'1;2;3;6;7'),(165,4,49,'1;2;3'),(166,4,50,'1;2;3'),(167,4,51,'1;2;3'),(168,4,52,'1;2;3'),(169,4,53,'1;2;3;8'),(170,4,54,'1;2;3;4'),(171,4,55,'1;2;3'),(172,4,57,'1;2;3;6'),(173,4,62,'6');
...
-- Dump completed on 2013-09-26 20:58:13
