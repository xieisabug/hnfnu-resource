...
CREATE TABLE `r_category` (
  ...
  `remark` text,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='类别表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `r_category` VALUES (5,'随碟附送',4,'asd'),(6,'123',1,''),(7,'松岛枫',6,'sdfsr');
...
INSERT INTO `r_course` VALUES (5,'第一课 霞霞美白记~',1,3,''),(7,'第二课 乌鸦喝水',8,2,'撒的撒·');
...
CREATE TABLE `r_grade` (
  ...
  `remark` text,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='年级表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `r_grade` VALUES (1,'一年级','243234'),(8,'二年级',''),(9,'三年级','二手房是的');
...
INSERT INTO `r_source` VALUES (12,'dsas',7,'dsas','','doc','','28160','','','','2013-10-18 16:06:55','0',NULL,0,0,0,'F:\\workspaces\\hnfnu-resource\\trunk\\hnfnuzyw\\WebRoot\\uploads\\20131018160644820131013141400.doc',6);
...
) ENGINE=InnoDB AUTO_INCREMENT=49 DEFAULT CHARSET=utf8 COMMENT='资源和类别的挂接表，一个资源有多个类别。一个类别也可以属于多个资源';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `r_source_category_join` VALUES (46,12,5),(47,12,6),(48,12,7);
...
INSERT INTO `r_subject` VALUES (2,'数学',''),(3,'历史',''),(4,'自然',''),(5,'英语','六级'),(6,'大学英语','asda');
...
) ENGINE=InnoDB AUTO_INCREMENT=47 DEFAULT CHARSET=utf8 COMMENT='专题资源挂接表';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `r_topic_source_join` VALUES (46,5,12);
...
INSERT INTO `s_menu` VALUES (40,-1,'管理系统','','',''),(41,-1,'资源库系统','','',''),(45,-1,'在线备课','','',''),(46,40,'菜单管理','App/System/Menu/MenuManage.html','1;3','./App/Lib/icons/32X32/product_169.gif'),(47,40,'角色管理','App/System/Role/RoleManage.html','1;2;3;6','./App/Lib/icons/32X32/product_169.gif'),(48,40,'用户管理','App/System/User/UserManage.html','1;2;3;6;7','./App/Lib/icons/32X32/product_169.gif'),(49,40,'功能管理','App/System/Function/FunctionManage.html','1;3','./App/Lib/icons/32X32/product_169.gif'),(50,40,'参数管理','App/System/Parameter/ParameterManage.html','1;2;3','./App/Lib/icons/32X32/product_169.gif'),(51,41,'学科管理','App/Resources/Subject/SubjectManage.html','1;2;3','./App/Lib/icons/32X32/product_169.gif'),(52,41,'年级管理','App/Resources/Grade/GradeManage.html','1;2;3','./App/Lib/icons/32X32/product_169.gif'),(53,41,'类别管理','App/Resources/Category/CategoryManage.html','1;2;3;8','./App/Lib/icons/32X32/product_169.gif'),(54,41,'课程管理','App/Resources/Course/CourseManage.html','1;2;3;4','./App/Lib/icons/32X32/product_169.gif'),(55,41,'资源管理','App/Resources/Source/SourceManage.html','1;2;3','./App/Lib/icons/32X32/product_169.gif'),(56,-1,'专题系统','','',''),(57,41,'专题管理','App/Resources/Topic/TopicManage.html','1;2;3;6','./App/Lib/icons/32X32/product_169.gif'),(61,-1,'网站系统','','',''),(62,61,'页面生成','App/Website/Page/PageManage.html','6','./App/Lib/icons/32X32/product_169.gif');
...
INSERT INTO `s_role` VALUES (4,'管理员',NULL,NULL,'sdgd'),(5,'资源录入员',6,NULL,''),(6,'静态页面生成员',6,'匡静',''),(7,'测试角色1号',6,'开发者',''),(8,'测试角色二号',6,'开发者','');
...
INSERT INTO `s_role_menu_join` VALUES (210,4,46,'1;3'),(211,4,47,'1;2;3;6'),(212,4,48,'1;2;3;6;7'),(213,4,49,'1;3'),(214,4,50,'1;2;3'),(215,4,51,'1;2;3'),(216,4,52,'1;2;3'),(217,4,53,'1;2;3;8'),(218,4,54,'1;2;3;4'),(219,4,55,'1;2;3'),(220,4,57,'1;2;3;6'),(221,4,62,'6');
...
INSERT INTO `s_user` VALUES (6,'admin','123456','开发者','430221199103101234','0','646208563','15575841234','2013-07-09','信息资源部',NULL,NULL,NULL,'ewt'),(8,'我叫测试','11111','sjakdjksa','430221199103102526','0','646208563','15575847475','2013-08-07','sdhs',NULL,NULL,NULL,'');
...
INSERT INTO `s_user_role_join` VALUES (59,6,4),(69,8,4);
...
-- Dump completed on 2013-10-20 16:01:03
