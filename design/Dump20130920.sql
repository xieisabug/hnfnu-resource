...
INSERT INTO `r_category` VALUES (1,'123',NULL,'');
...
BEGIN
	DELETE FROM r_source_category_join WHERE r_source_category_join.categoryId = old.id;
END */;;
DELIMITER ;
...
INSERT INTO `r_source` VALUES (1,'aaa',1,'aaa','','','','0','','','','2013-09-17 20:28:18','0',NULL,0,0,0,'D:\\hnfnu-resource\\trunk\\hnfnuzyw\\WebRoot\\uploads\\0[1].jpg',6),(2,'111111',5,'111111','文档','doc','','120832','','','',NULL,NULL,NULL,0,NULL,NULL,'D:\\hnfnu-resource\\trunk\\hnfnuzyw\\WebRoot\\uploads\\2页版 谢景扬.doc',NULL);
...
INSERT INTO `r_source_category_join` VALUES (1,1,1),(2,2,1);
...
/*!50003 SET sql_mode              = 'STRICT_TRANS_TABLES,NO_AUTO_CREATE_USER,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50017 DEFINER=`root`@`localhost`*/ /*!50003 TRIGGER `r_source_category_join_BDEL` BEFORE DELETE ON r_source_category_join FOR EACH ROW
BEGIN
	DELETE FROM r_source WHERE r_source.id = old.sourceId;
END */;;
DELIMITER ;
/*!50003 SET sql_mode              = @saved_sql_mode */ ;
/*!50003 SET character_set_client  = @saved_cs_client */ ;
...
INSERT INTO `s_menu` VALUES (40,-1,'管理系统','','',''),(41,-1,'资源库系统','','',''),(45,-1,'在线备课','','',''),(46,40,'菜单管理','App/System/Menu/MenuManage.html','1;2;3','./App/Lib/icons/32X32/product_169.gif'),(47,40,'角色管理','App/System/Role/RoleManage.html','1;2;3;6','./App/Lib/icons/32X32/product_169.gif'),(48,40,'用户管理','App/System/User/UserManage.html','1;2;3;6;7','./App/Lib/icons/32X32/product_169.gif'),(49,40,'功能管理','App/System/Function/FunctionManage.html','1;2;3','./App/Lib/icons/32X32/product_169.gif'),(50,40,'参数管理','App/System/Parameter/ParameterManage.html','1;2;3','./App/Lib/icons/32X32/product_169.gif'),(51,41,'学科管理','App/Resources/Subject/SubjectManage.html','1;2;3','./App/Lib/icons/32X32/product_169.gif'),(52,41,'年级管理','App/Resources/Grade/GradeManage.html','1;2;3','./App/Lib/icons/32X32/product_169.gif'),(53,41,'类别管理','App/Resources/Category/CategoryManage.html','1;2;3','./App/Lib/icons/32X32/product_169.gif'),(54,41,'课程管理','App/Resources/Course/CourseManage.html','1;2;3;4','./App/Lib/icons/32X32/product_169.gif'),(55,41,'资源管理','App/Resources/Source/SourceManage.html','1;2;3','./App/Lib/icons/32X32/product_169.gif'),(56,-1,'专题系统','','',''),(57,41,'专题管理','App/Resources/Topic/TopicManage.html','1;2;3;6','./App/Lib/icons/32X32/product_169.gif'),(58,41,'测试','','1;2;3;4',''),(61,-1,'网站系统','','',''),(62,61,'页面生成','App/Website/Page/PageManage.html','6','./App/Lib/icons/32X32/product_169.gif');
...
INSERT INTO `s_role_menu_join` VALUES (29,1,46,'1;2;3'),(30,1,47,'1;2;3;6'),(31,2,47,'1;2;3;6'),(117,6,48,'1;2;3;6'),(118,6,50,'1;2;3'),(119,6,51,'1;2;3'),(120,6,55,'1;2;3'),(134,3,53,'1;2;3'),(135,3,54,'1;2;3'),(136,3,55,'1;2;3'),(137,3,57,'1;2;3;6'),(150,4,46,'1;2;3'),(151,4,47,'1;2;3;6'),(152,4,48,'1;2;3;6;7'),(153,4,49,'1;2;3'),(154,4,50,'1;2;3'),(155,4,51,'1;2;3'),(156,4,52,'1;2;3'),(157,4,53,'1;2;3'),(158,4,54,'1;2;3;4'),(159,4,55,'1;2;3'),(160,4,57,'1;2;3;6'),(161,4,62,'6');
...
-- Dump completed on 2013-09-20 23:43:45
