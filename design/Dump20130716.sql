...
INSERT INTO `r_course` VALUES (1,'第一课 小妈妈找蝌蚪',1,1,'sdjk'),(3,'第二课 小胖胖找小笨笨',2,3,''),(4,'第三课 吃南瓜粑粑',3,4,'');
...
CREATE TABLE `r_source_category_join` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=8 DEFAULT CHARSET=utf8 COMMENT='资源和类别的挂接表，一个资源有多个类别。一个类别也可以属于多个资源';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `r_source_category_join` VALUES (1,9,1),(2,9,2),(3,10,1),(4,10,2),(5,10,3),(6,10,4),(7,10,5);
...
-- Dump completed on 2013-07-16 10:58:09
