...
public class Url {
	//realPath是文件上传的真正的路径
	public static final String realPath ="F:\\Workspaces\\hnfnu-resource\\trunk\\hnfnuzyw\\out\\artifacts\\hnfnuzyw_war_exploded\\" ;
	//这个是登陆界面的相对路径，
	...
	//freemark要用到的生成路径
    public final static String FREEMRAK_FILE_PATH = "F:\\Workspaces\\hnfnu-resource\\trunk\\hnfnuzyw\\WebRoot\\";
}
